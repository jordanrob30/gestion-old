...
$user->login("jordanr","1234",false);
print_r($user->get_user_info()) . "<br>";
echo $user->get_last_error();
...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="themes/<?=$theme?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>Gestion</b></a>
    </div>
    <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="themes/<?=$theme?>/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
